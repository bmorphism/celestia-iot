...
type Sandwhich struct {
	...
	Meat  string `protobuf:"bytes,2,opt,name=meat,proto3" json:"meat,omitempty"`
}

func (m *Sandwhich) Reset()         { *m = Sandwhich{} }
func (m *Sandwhich) String() string { return proto.CompactTextString(m) }
func (*Sandwhich) ProtoMessage()    {}
func (*Sandwhich) Descriptor() ([]byte, []int) {
	return fileDescriptor_9897659aff976806, []int{5}
}
func (m *Sandwhich) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Sandwhich) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Sandwhich.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Sandwhich) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sandwhich.Merge(m, src)
}
func (m *Sandwhich) XXX_Size() int {
	return m.Size()
}
func (m *Sandwhich) XXX_DiscardUnknown() {
	xxx_messageInfo_Sandwhich.DiscardUnknown(m)
}

var xxx_messageInfo_Sandwhich proto.InternalMessageInfo

func (m *Sandwhich) GetBread() string {
	if m != nil {
		return m.Bread
	}
	return ""
...
func (m *Sandwhich) GetMeat() string {
	if m != nil {
		return m.Meat
	}
	return ""
...
type SandwhichResponse struct {
	Sandwhich *types.Any `protobuf:"bytes,1,opt,name=sandwhich,proto3" json:"sandwhich,omitempty"`
}

func (m *SandwhichResponse) Reset()         { *m = SandwhichResponse{} }
func (m *SandwhichResponse) String() string { return proto.CompactTextString(m) }
func (*SandwhichResponse) ProtoMessage()    {}
func (*SandwhichResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9897659aff976806, []int{6}
}
func (m *SandwhichResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SandwhichResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SandwhichResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SandwhichResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SandwhichResponse.Merge(m, src)
}
func (m *SandwhichResponse) XXX_Size() int {
	return m.Size()
}
func (m *SandwhichResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SandwhichResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SandwhichResponse proto.InternalMessageInfo

func (m *SandwhichResponse) GetSandwhich() *types.Any {
	if m != nil {
		return m.Sandwhich
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Sandwhich)(nil), "payment.Sandwhich")
	proto.RegisterType((*SandwhichResponse)(nil), "payment.SandwhichResponse")
}
...
var fileDescriptor_9897659aff976806 = []byte{
	...
	,
}
...
func (m *Sandwhich) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Sandwhich) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Sandwhich) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Bread) > 0 {
		i -= len(m.Bread)
		copy(dAtA[i:], m.Bread)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Bread)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SandwhichResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SandwhichResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SandwhichResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Sandwhich != nil {
		{
			size, err := m.Sandwhich.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SandwhichResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Sandwhich) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Sandwhich: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Sandwhich: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Bread", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Bread = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *SandwhichResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SandwhichResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SandwhichResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Sandwhich", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Sandwhich == nil {
				m.Sandwhich = &types.Any{}
			}
			if err := m.Sandwhich.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
